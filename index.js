...
+body1.segments[0].flights[0].IfId +" departure time :" +body1.segments[0].flights[0].stops.departureTime+"departure time :"+ body1.segments[0].flights[0].stops.arrivalTime;
