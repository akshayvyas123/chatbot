...
+response1.segment[0].flights[0].lfId +" departure time :" +response1.segment[0].flights[0].stops.departureTime+"departure time :"+ response1.segment[0].flights[0].stops.arrivalTime;
